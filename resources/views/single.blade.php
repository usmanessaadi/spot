                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <article class="hentry post post-standard-details">
                        ...
                        <div class="post-thumb">
                            <img src="{{ asset('storage/images/'. $post->featured) }}" alt="seo">
                        </div>
                        ...
                        <div class="socials text-center">
                            ...
                            <div class="addthis_inline_share_toolbox_s0k8"></div>
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-thumb">
                            <img src="{{ asset('storage/avatars/'.$post->user->profile->avatar) }}" width="110" alt="Author">
                        </div>
                        ...
                        <div class="blog-details-author-content">
                            ...
                            <div class="socials">
                                ...
                                <a href="http://{{ $post->user->profile->facebook }}" target="_blank" class="social__item">
                                    <img src="{{ asset('app/svg/circle-facebook.svg') }}" alt="facebook">
                                </a>


                                <a href="http://{{ ($post->user->profile->youtube) }}" target="_blank" class="social__item">
