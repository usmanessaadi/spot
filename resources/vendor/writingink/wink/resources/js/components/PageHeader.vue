    ...
    <div class="container">
      <div class="flex items-center py-2">
        <div class="flex items-center mr-auto h-8">
          <h3
            class="mr-5 font-semibold font-serif"
            :class="{'hidden': hideLogoOnSmallScreens, 'sm:block': hideLogoOnSmallScreens}"
          >
            <router-link to="/" class="no-underline text-text-color">
              <span class="text-light">S</span>pot.
            </router-link>
          </h3>
        ...
        <div class="flex items-center">
          ...
          <dropdown class="relative ml-6">
            ...
            <div slot="content" class="dropdown-content pin-r min-w-dropdown mt-1 text-sm py-2">
              <router-link
                :to="{name:'team-edit', params:{id: Wink.author.id}}"
                class="no-underline text-text-color font-sans hover:text-primary w-full block py-2 px-4 border-b border-very-light"
              >Profile</router-link>
              <router-link
                to="/posts"
              ...
              <a
                ...
                class="no-underline text-text-color hover:text-primary w-full block py-2 px-4 border-t border-very-light"
              >Log out</a>
            </div>
          </dropdown>
        </div>
